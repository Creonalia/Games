...
start_1 = t((100, 50), "Move Right to Proceed")
...
r3_0 = b(4, 22, 2, 2, "Bouncy", 1)
r3_2 = b(14, 22, 2, 2, "Bouncy", 1)
r3_4 = b(20, 18, 2, 2, "Bouncy")
r3_5 = b(12, 14, 6, 1, "Lava")
r3_6 = b(12, 13, 6, 1)
r3_7 = b(14, 13, 2, 1, "Bouncy", 1)
r3_8 = b(2, 14, 6, 1, "Lava")
r3_9 = b(2, 13, 6, 1)
r3_10 = b(4, 13, 2, 1, "Bouncy", 1)
r3_11 = b(0, 8, 2, 2, "Bouncy")
...
# rooms
start = classes.Room((ground,), (start_0, start_1))
r1 = classes.Room((ground, r1_0, r1_1, r1_2, r1_3, r1_4, r1_5))
r2 = classes.Room((ground, r2_0, r2_1, r2_2, r2_3, r2_4, r2_5, r2_6, r2_7,r2_8))
r3 = classes.Room((ground, r3_0, r3_2, r3_4, r3_5, r3_6, r3_7, r3_8, r3_9, r3_10, r3_11, r3_12, r3_13, r3_14, r3_15, r3_16, r3_17))
end = classes.Room((ground,), (end_0, end_1))
